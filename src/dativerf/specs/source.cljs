...
(s/def ::crossref ::common/string-lte-1000)
...
(s/def ::key (s/and string?
                    (partial
                     re-find
                     #"^[0-9a-zA-Z!\"'#\$%&\(\)\^\*+\./:;<=>\?@\[\]\{\}\\_`\|~-]{1,1000}$")))
(s/def ::journal ::common/string-lte-255)
(s/def ::editor ::common/string-lte-255)
(s/def ::chapter ::common/string-lte-255)
(s/def ::pages ::common/string-lte-100)
(s/def ::publisher ::common/string-lte-255)
(s/def ::booktitle ::common/string-lte-255)
(s/def ::school ::common/string-lte-255)
(s/def ::institution ::common/string-lte-255)
(s/def ::year int?)
(s/def ::author ::common/string-lte-255)
(s/def ::title ::common/string-lte-255)
(s/def ::note ::common/string-lte-1000)
...
(s/def ::address ::common/string-lte-1000)
(s/def ::annote string?)
(s/def ::edition ::common/string-lte-255)
(s/def ::howpublished ::common/string-lte-255)
(s/def ::key-field ::common/string-lte-255)
(s/def ::month ::common/string-lte-100)
(s/def ::number ::common/string-lte-100)
(s/def ::organization ::common/string-lte-255)
(s/def ::series ::common/string-lte-255)
(s/def ::type-field ::common/string-lte-255)
(s/def ::url ::common/string-lte-1000)
(s/def ::volume ::common/string-lte-100)

;; Optional Non-standard BibTeX keys
(s/def ::abstract ::common/string-lte-1000)
(s/def ::affiliation ::common/string-lte-255)
(s/def ::contents ::common/string-lte-255)
(s/def ::copyright ::common/string-lte-255)
(s/def ::keywords ::common/string-lte-255)
(s/def ::language ::common/string-lte-255)
(s/def ::location ::common/string-lte-255)
(s/def ::size ::common/string-lte-255)
(s/def ::price ::common/string-lte-100)
(s/def ::mrnumber ::common/string-lte-25)
(s/def ::isbn ::common/string-lte-20)
(s/def ::issn ::common/string-lte-20)
(s/def ::lccn ::common/string-lte-20)
