...
* [`src/dativerf/styles.cljs`](src/dativerf/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/dativerf/`](src/dativerf/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/dativerf/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `dativerf` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/dativerf/config.cljs) defaults to `true` in
...
```clj
(ns dativerf.example
  (:require [dativerf.config :as config])
